var app = {
  ...
  handleSidebarMenu = function () {
    ...
    var n = t + s + s,
      p = [].slice.call(
        document.querySelectorAll(n + " > ." + app.sidebar.menu.itemLinkClass)
      );
      ...
      (a.onchange = function () {
        this.checked
          ? document
              ...
              .classList.add(app.themePanel.themeHeader.class)
          : document
              .querySelector("." + app.header.class)
              .classList.remove(app.themePanel.themeHeader.class),
    ...
    (e = [].slice.call(
      ...
      e.onchange = function () {
        this.checked
          ? document
              .querySelector("html")
              .classList.add(app.themePanel.themeDarkMode.class)
          : document
              .querySelector("html")
              .classList.remove(app.themePanel.themeDarkMode.class),
          App.initVariable(),
          setCookie(
      ...
      if (e) {
        var a = window.getComputedStyle(e),
          ...
          l =
            ...
            document.querySelector("." + app.topMenu.class).clientWidth - 128),
          o = 0,
          r = 0,
          i = [].slice.call(
            document.querySelectorAll(
          ...
          if (e && e.classList.contains(app.sidebar.minify.toggledClass)) {
            ...
            if (t) {
              var s = getComputedStyle(document.body),
                ...
                o = parseInt(
                  document.querySelector(app.sidebar.id).clientWidth
                ),
                r =
    ...
    if (a) {
      ...
      if (e.appContentClass)
        if ((t = document.querySelector("." + app.content.class)))
          for (s = e.appContentClass.split(" "), l = 0; l < s.length; l++)
            t.classList.add(s[l]);
      if (e.bodyClass)
  ...
  handleClearPageOption = function (e) {
    ...
    if (a) {
      ...
      if (e.appContentClass)
        if ((t = document.querySelector("." + app.content.class)))
          for (var s = e.appContentClass.split(" "), l = 0; l < s.length; l++)
        ...
        switch (a) {
          ...
          case "number":
            ...
            const a = () => {
              ...
              if (o < e) {
                var i = o + r;
                (s.innerText = convertNumberWithCommas(i.toFixed(l))),
                  (s.count = i),
                  setTimeout(a, 1);
