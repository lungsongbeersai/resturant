...
(function () {
  ...
  (function (t, e) {
      ...
      special: {
        ...
        click: {
          setup: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && S(e, "input") && Tt(e, "click", wt),
              !1
            );
          },
          trigger: function (t) {
            var e = this || t;
            return (
              dt.test(e.type) && e.click && S(e, "input") && Tt(e, "click"), !0
            );
          },
          _default: function (t) {
            var e = t.target;
    ...
    w.extend({
      ...
      w.each(["height", "width"], function (t, e) {
        w.cssHooks[e] = {
          get: function (t, i, n) {
            if (i)
              return !Kt.test(w.css(t, "display")) ||
        ...
        _default: {
          ...
          set: function (t) {
            w.fx.step[t.prop]
              ? w.fx.step[t.prop](t)
              : 1 !== t.elem.nodeType ||
                (!w.cssHooks[t.prop] && null == t.elem.style[Ut(t.prop)])
              ? (t.elem[t.prop] = t.now)
    ...
    (w.Animation = w.extend(ue, {
        ...
        stop: function (t, e, i) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (s in r) r[s] && r[s].stop && re.test(s) && n(r[s]);
              for (s = o.length; s--; )
                o[s].elem !== this ||
                  (null != t && o[s].queue !== t) ||
      ...
      (ne = m.createElement("input")),
      (se = m.createElement("select").appendChild(m.createElement("option"))),
      (ne.type = "checkbox"),
      (p.checkOn = "" !== ne.value),
      (p.optSelected = se.selected),
      ((ne = m.createElement("input")).value = "t"),
      (ne.type = "radio"),
      (p.radioValue = "t" === ne.value);
    var de,
      pe = w.expr.attrHandle;
    w.fn.extend({
      attr: function (t, e) {
        ...
        toggleClass: function (t, e) {
          ...
          return f(t)
            ...
            : ((i = _e(t)),
              this.each(function () {
                if (a)
                  for (o = w(this), s = 0; s < i.length; s++)
                    (n = i[s]),
                      o.hasClass(n) ? o.removeClass(n) : o.addClass(n);
                else
                  (void 0 !== t && "boolean" !== r) ||
                    ((n = ve(this)) && V.set(this, "__className__", n),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        n || !1 === t ? "" : V.get(this, "__className__") || ""
                      ));
              }));
        },
        hasClass: function (t) {
          var e,
            ...
            n = 0;
          for (e = " " + t + " "; (i = this[n++]); )
            if (1 === i.nodeType && -1 < (" " + me(ve(i)) + " ").indexOf(e))
              return !0;
          return !1;
        },
      });
    ...
    w.extend(w.event, {
      trigger: function (e, i, n, s) {
        ...
        if (
          ...
          if (!s && !d.noBubble && !g(n)) {
            for (
              l = d.delegateType || _, ye.test(l + _) || (r = r.parentNode);
              r;
              r = r.parentNode
            )
              v.push(r), (a = r);
          ...
          return (
            ...
            s ||
              ...
              (h &&
                ...
                ((a = n[h]) && (n[h] = null),
                (w.event.triggered = _),
                e.isPropagationStopped() && p.addEventListener(_, we),
                n[_](),
                e.isPropagationStopped() && p.removeEventListener(_, we),
          ...
          p.hasContent
            ...
            : ((d = p.url.slice(s.length)),
              p.data &&
                ...
                ((s += (ke.test(s) ? "&" : "?") + p.data), delete p.data),
              !1 === p.cache &&
                ((s = s.replace(Me, "$1")),
                (d = (ke.test(s) ? "&" : "?") + "_=" + Ce.guid++ + d)),
              (p.url = s + d)),
          p.ifModified &&
            (w.lastModified[s] &&
    ...
    (p.cors = !!Be && "withCredentials" in Be),
      (p.ajax = Be = !!Be),
      w.ajaxTransport(function (e) {
        var i, n;
        if (p.cors || (Be && !e.crossDomain))
          return {
            send: function (s, o) {
              var r,
                a = e.xhr();
    ...
    w.ajaxSetup({
          ...
          return (
            ...
            n.always(function () {
              void 0 === o ? w(t).removeProp(s) : (t[s] = o),
                e[s] && ((e.jsonpCallback = i.jsonpCallback), $e.push(s)),
                r && f(o) && o(r[0]),
                (r = o = void 0);
            }),
            "script"
      ...
      (p.createHTMLDocument =
        (((Xe = m.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (w.fn.load = function (t, e, i) {
        var n,
          ...
          a = t.indexOf(" ");
        return (
          -1 < a && ((n = me(t.slice(a))), (t = t.slice(0, a))),
          f(e)
            ? ((i = e), (e = void 0))
      ...
      w.each(["top", "left"], function (t, e) {
        w.cssHooks[e] = Yt(p.pixelPosition, function (t, i) {
          if (i)
            return (i = qt(t, e)), Lt.test(i) ? w(t).position()[e] + "px" : i;
        });
      }),
    ...
    return (
      (w.noConflict = function (e) {
        return (
          t.$ === w && (t.$ = Ge), e && t.jQuery === w && (t.jQuery = Ve), w
        );
      }),
  ...
  (function (t) {
    ...
    function P(t) {
      ...
      return (
        ...
        i.length
          ? ("0,0,0,0" === i.join() && _.extend(i, $.transparent), e)
          : $[t]
      );
    }
    function M(t, e, i) {
  ...
  (function (t, e) {
    ...
    class at extends q {
      ...
      _maybeEnableCycle() {
        this._config.ride &&
          (this._isSliding
            ? N.one(this._element, et, () => this.cycle())
            : this.cycle());
      }
      to(t) {
        ...
        if (this._isSliding)
          return void N.one(this._element, et, () => this.to(t));
    ...
    function Vt(t, e) {
      ...
      if (qt(t) && e) {
        var o = t.offsetHeight,
          r = t.offsetWidth;
        r > 0 && (n = Kt(i.width) / r || 1),
          o > 0 && (s = Kt(i.height) / o || 1);
      }
      return {
        width: i.width / n,
        height: i.height / s,
    ...
    function ee(t) {
      return "html" === zt(t)
        ? t
        : t.assignedSlot || t.parentNode || (Yt(t) ? t.host : null) || te(t);
    }
    function ie(t) {
    ...
    function ne(t) {
      for (
        ...
        i = ie(i);
      return i &&
        ("html" === zt(i) || ("body" === zt(i) && "static" === Jt(i).position))
        ? e
        : i ||
            (function (t) {
              var e =
            ...
            (function (t) {
              ...
              return (
                "rtl" === Jt(s || i).direction &&
                  (a += $t(i.clientWidth, s ? s.clientWidth : 0) - o),
          ...
          if (x) {
            if (o) {
              var E,
                ...
                B = oe(0, C[M], j[M]),
                X = b
                  ? C[M] / 2 - H - B - q - D.mainAxis
                  : W - B - q - D.mainAxis,
                $ = b
                  ? -C[M] / 2 + H + B + Y + D.mainAxis
                  : R + B + Y + D.mainAxis,
          ...
          (("body" !== zt(e) || we(a)) &&
            (h =
              (n = e) !== jt(n) && qt(n)
                ...
                : be(n)),
          qt(e)
            ? (((c = Vt(e, !0)).x += e.clientLeft), (c.y += e.clientTop))
            : a && (c.x = ye(a))),
        {
    ...
    class di {
      ...
      _resetElementAttributes(t, e) {
        this._applyManipulationCallback(t, (t) => {
          ...
          null !== i
            ? (j.removeDataAttribute(t, e), t.style.setProperty(e, i))
    ...
    class xi extends F {
      ...
      activate() {
        this._isActive ||
          ...
          N.on(document, "keydown.tab.bs.focustrap", (t) =>
      ...
      constructor(t) {
        super(t),
          ...
          this._parent &&
            ...
            N.on(this._element, "keydown.bs.tab", (t) => this._keydown(t)));
      }
      static get NAME() {
        return "tab";
      }
    ...
    class Pn extends q {
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(Dn),
                  this._element.classList.remove(An, Sn),
      ...
      _setListeners() {
        N.on(this._element, "mouseover.bs.toast", (t) =>
          this._onInteraction(t, !0)
        ),
          N.on(this._element, "mouseout.bs.toast", (t) =>
            this._onInteraction(t, !1)
          ),
          N.on(this._element, "focusin.bs.toast", (t) =>
            this._onInteraction(t, !0)
          ),
          N.on(this._element, "focusout.bs.toast", (t) =>
            this._onInteraction(t, !1)
          );
      }
      _clearTimeout() {
