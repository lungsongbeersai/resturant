...
?>
    <thead style="border: 1px solid white !important;vertical-align:middle !important">
        <tr>
            ...
            <td colspan="2" align="center">ອັດຕາແລກປ່ຽນ</td>
        ...
        <tr>
            <td align="center">ບາດ-ກີບ</td>
            <td align="center">ໂດຣາ-ກີບ</td>
...
?>
            <tr class="table_hover <?php echo $color;?>">
                ...
                <td align="center">
                    <a href="?print_Preview&&list_bill_no=<?php echo base64_encode($row_sql['list_bill_no'])?>&&tableName=<?php echo base64_encode($row_sql['table_name'])?>&&branch_code=<?php echo base64_encode($row_sql['list_bill_branch_fk'])?>" target="_bank" style="text-decoration:none;color:#825b00 !important"><ion-icon name="print-outline"></ion-icon> <?php echo $row_sql["list_bill_no"]?></a>
                </td>
