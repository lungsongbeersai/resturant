...
<body class='pace-top'>
    ...
    <script>
        ...
        function load_orders(idStatus) {
            ...
            $.ajax({
                url: "services/sql/service-cooks.php?loadOrders",
                method: "POST",
                data: {
                    idStatus
                },
        ...
        function countData() {
            $.ajax({
                url: "services/sql/service-cooks.php?countLabel",
                method: "POST",
                dataType: "json",
                success: function(data) {
        ...
        function fnConfirm(cookID, cookStatus) {
            ...
            $.ajax({
                url: "services/sql/service-cooks.php?editStatus",
                method: "POST",
                data: {
                    cookID,
                    cookStatus
